...
public:
    ...
    void boxShadowInset(cairo_t* const cr, int width, int height, int x = 0, int y = 0, bool fill = false)
    {
    ...
    void boxShadowOutset(cairo_t* const cr, int width, int height, int x = 0, int y = 0, bool fill = false)
    {
        cairo_pattern_t *pat = cairo_pattern_create_linear (x, y, x + width, y);
        cairo_pattern_add_color_stop_rgba
